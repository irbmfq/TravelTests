...
public class SimpleHttpPostRequest {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        File file = new File("C:\\Documents and Settings\\samaitra\\Desktop\\501.txt");
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                ...
                for (String next : urls) {
                    ...
                    try {
                        String url="http://dbds-lm23.websys.travel.com:9010/write/add_comment";
                        String urlParameters =
                            "version=" + URLEncoder.encode("1", "UTF-8") +
                            "&channel_id=" + URLEncoder.encode("30", "UTF-8")+
                            "&body=" + URLEncoder.encode(next, "UTF-8")+
                            "&topic_id=" + URLEncoder.encode("test_spam_1", "UTF-8")+
                            "&user_id=" + URLEncoder.encode("samaitra", "UTF-8");
